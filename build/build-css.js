...
var save = function(file, content) {
  fs.writeFileSync(resolve(__dirname, "../packages/dist/", file), content);
};
var load = function(file) {
  return fs
    .readFileSync(resolve(__dirname, "../packages/style/", file))
    .toString();
};
var loadDist = function(file) {
  return fs
    .readFileSync(resolve(__dirname, "../packages/dist/", file))
    .toString();
};

processor
  .process(load(file), {
    from: resolve(__dirname, "../packages/style/", file)
  })
